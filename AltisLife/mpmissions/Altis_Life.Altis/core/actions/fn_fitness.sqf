...
if(life_hunger < 85) exitWith {hint "Geh was essen bevor du die Liegestütze machst!";};
if(life_thirst < 85) exitWith {hint "Geh was trinken bevor du die Liegestütze machst!";};

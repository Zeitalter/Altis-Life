...
"Marker200" setMarkerType "mil_warning"; [[0,format["ALARM! - Gasstation: %1 wird überfallen!", _shop]],"life_fnc_broadcast",west,false] spawn life_fnc_MP; }; // <-----------NEU NEU NEU
...
life_use_atm = true; 
if!(alive _robber) exitWith {};
[[0,format["112 - Tankstelle: %2 wurde gerade von %1 ausgeraubt und hat %3€ erbeutet",name _robber, _shop, [_kassa] call life_fnc_numberText]],"life_fnc_broadcast",west,false] spawn life_fnc_MP;
[[0,format["NEWS: Tankstelle: %1 wurde gerade von %2 ausgeraubt und hat %3€ erbeutet", _shop,name _robber, [_kassa] call life_fnc_numberText]],"life_fnc_broadcast",civilian,false] spawn life_fnc_MP;

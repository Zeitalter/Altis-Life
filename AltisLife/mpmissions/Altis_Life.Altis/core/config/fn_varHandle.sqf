	...
	case 0:
	{
		switch (_var) do
		{
			...
			case "methu": {"life_inv_methu"};
            	...
            	case "bitcoinu": {"life_inv_bitcoinu"};
            	case "bitcoinp": {"life_inv_bitcoinp"};
            	case "bottledbeer": {"life_inv_bottledbeer"};
			case "bottledwhiskey": {"life_inv_bottledwhiskey"};
			case "tentciv": {"life_inv_tentciv"};
			case "profiwerkzeug": {"life_inv_profiwerkzeug"}; //profiwerkzeug
		};
	};
	...
	case 1:
	{
		switch (_var) do
		{
			...
			case "life_inv_methu": {"methu"};
            	...
            	case "life_inv_bitcoinu": {"bitcoinu"};
            	case "life_inv_bitcoinp": {"bitcoinp"};

...
switch (_className) do
{
	...
	case "O_MRAP_02_F": {60};
	case "I_MRAP_03_F": {58};
	case "B_Heli_Light_01_F": {95}; // C_Heli_Light_01_civil_F 
	case "C_Heli_Light_01_civil_F": {110};
	case "O_Heli_Light_02_unarmed_F": {150};
	case "I_Heli_Transport_02_F": {345};
	case "I_Heli_light_03_unarmed_F": {150};
	case "I_Heli_light_03_F": {150};
	case "B_Heli_Transport_01_F": {125};
	...
	case "O_Truck_03_fuel_F": {2000};
	case "O_Truck_03_ammo_F": {500};
//	case "B_Heli_Attack_01_F": {50};
	default {-1};
};

...
closeDialog 0;
hintSilent parseText format["Dein Promillewert ist nun<br/> <t size='1.4'><t color='#FF0000'>%1</t></t>",[life_drink] call life_fnc_numberText];
sleep 4;
...
if(life_drink != 0) then {life_drink = life_drink - 0.2;}; 
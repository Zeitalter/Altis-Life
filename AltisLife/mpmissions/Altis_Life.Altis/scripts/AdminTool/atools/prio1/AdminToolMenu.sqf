_pathtovehiclescars = "scripts\AdminTool\atools\prio1\vehicles\Autos\";
_pathtovehicleshelis = "scripts\AdminTool\atools\prio1\vehicles\Helis\";
_pathtovehiclespanzer = "scripts\AdminTool\atools\prio1\vehicles\Panzer\";
_pathtovehiclesoffroad = "scripts\AdminTool\atools\prio1\vehicles\Offroad\";
_pathtovehiclesflugzeug = "scripts\AdminTool\atools\prio1\vehicles\Flugzeug\";
_pathtovehiclesMPS = "scripts\AdminTool\atools\prio1\weapons\MPS\";
_pathtovehiclesSturmgewehre = "scripts\AdminTool\atools\prio1\weapons\Sturmgewehre\";
_pathtovehiclesSniper = "scripts\AdminTool\atools\prio1\weapons\Sniper\";
_pathtovehiclesPistolen = "scripts\AdminTool\atools\prio1\weapons\Pistolen\";
_pathtovehiclesMG = "scripts\AdminTool\atools\prio1\weapons\MGS\";
_pathtotools = "scripts\AdminTool\atools\prio1\tools\";
...
if ((getPlayerUID player) in ["76561198035863318","76561198066223827","76561198128817311"]) then { // Admin PlayerID Eintragen <--- Hier Bitte Alle Admins eintragen!
	...
	if ((getPlayerUID player) in ["76561198035863318","76561198066223827","76561198128817311"]) then { // Admin PlayerID Eintragen
        adminmenu =
        [
			["",true],
	...
	if ((getPlayerUID player) in ["76561198035863318","76561198066223827","76561198128817311"]) then { // Super Admin PlayerID Eintragen
		adminmenu =
		[
			["",true],

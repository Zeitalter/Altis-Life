_pathtovehiclescars = "scripts\AdminTool\atools\prio2\vehicles\Autos\";
_pathtovehicleshelis = "scripts\AdminTool\atools\prio2\vehicles\Helis\";
_pathtovehiclespanzer = "scripts\AdminTool\atools\prio2\vehicles\Panzer\";
_pathtovehiclesoffroad = "scripts\AdminTool\atools\prio2\vehicles\Offroad\";
_pathtovehiclesflugzeug = "scripts\AdminTool\atools\prio2\vehicles\Flugzeug\";
_pathtovehiclesMPS = "scripts\AdminTool\atools\prio2\weapons\MPS\";
_pathtovehiclesSturmgewehre = "scripts\AdminTool\atools\prio2\weapons\Sturmgewehre\";
_pathtovehiclesSniper = "scripts\AdminTool\atools\prio2\weapons\Sniper\";
_pathtovehiclesPistolen = "scripts\AdminTool\atools\prio2\weapons\Pistolen\";
_pathtovehiclesMG = "scripts\AdminTool\atools\prio2\weapons\MGS\";
_pathtotools = "scripts\AdminTool\atools\prio2\tools\";
...
if ((getPlayerUID player) in ["76561197992914992"]) then { // Admin PlayerID Eintragen <--- Hier Bitte Alle Admins eintragen!
	...
	if ((getPlayerUID player) in ["76561197992914992"]) then { // Admin PlayerID Eintragen
        adminmenu =
        [
			["",true],
	...
	if ((getPlayerUID player) in ["76561197992914992"]) then { // Super Admin PlayerID Eintragen
		adminmenu =
		[
			["",true],
...
[
	["",true],
		...
		["Spieler beobachten", [6],  "", -5, [["expression", format[_EXECscript4,"spectate.sqf"]]], "1", "1"],
		...
		["Geld", [11], "", -5, [["expression", format[_EXECscript4, "cash.sqf"]]], "1", "1"],
		["", [-1], "", -5, [["expression", ""]], "1", "0"],
			["Exit", [13], "", -3, [["expression", ""]], "1", "1"]
];
/*SpawnMenu =

_pathtovehiclescars = "scripts\AdminTool\atools\prio3\vehicles\Autos\";
_pathtovehicleshelis = "scripts\AdminTool\atools\prio3\vehicles\Helis\";
_pathtovehiclespanzer = "scripts\AdminTool\atools\prio3\vehicles\Panzer\";
_pathtovehiclesoffroad = "scripts\AdminTool\atools\prio3\vehicles\Offroad\";
_pathtovehiclesflugzeug = "scripts\AdminTool\atools\prio3\vehicles\Flugzeug\";
_pathtovehiclesMPS = "scripts\AdminTool\atools\prio3\weapons\MPS\";
_pathtovehiclesSturmgewehre = "scripts\AdminTool\atools\prio3\weapons\Sturmgewehre\";
_pathtovehiclesSniper = "scripts\AdminTool\atools\prio3\weapons\Sniper\";
_pathtovehiclesPistolen = "scripts\AdminTool\atools\prio3\weapons\Pistolen\";
_pathtovehiclesMG = "scripts\AdminTool\atools\prio3\weapons\MGS\";
_pathtotools = "scripts\AdminTool\atools\prio3\tools\";
...
if ((getPlayerUID player) in ["76561198087840033"]) then { // Admin PlayerID Eintragen <--- Hier Bitte Alle Admins eintragen!
	...
	if ((getPlayerUID player) in ["76561198087840033"]) then { // Admin PlayerID Eintragen
        adminmenu =
        [
			["",true],
	...
	if ((getPlayerUID player) in ["76561198087840033"]) then { // Super Admin PlayerID Eintragen
		adminmenu =
		[
			["",true],
...
[
	["",true],
		...
		["Schluessel geben", [10], "", -5, [["expression", format[_EXECscript4, "schluessel.sqf"]]], "1", "1"],
...
[
	["Sturmgewehr Waffen",true],
		["MX", [2],  "", -5, [["expression", format[_EXECscript9,"arifle_MX_GL_Black_Hamr_pointer_F.sqf"]]], "1", "1"],
		["Exit", [13], "", -3, [["expression", ""]], "1", "1"]

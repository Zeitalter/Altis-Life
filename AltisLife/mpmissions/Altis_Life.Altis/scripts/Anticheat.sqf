...
_Admins = ["76561198035863318","76561198066223827","76561198125588464","76561198128817311","76561198063823181","76561198110660001","76561198036953127","76561198118042556","76561198037633698","76561198037633698"]; 			//Add your admin UID here
_Use_Life_fnc_MP = false;					//If you are using altis life change this to true

//Add new cheat files & variables & menus to these lists
_DetectedFiles = ["hack.sqf","G-e-F_HackInit.sqf","gef.png","g-e-f.sqf","G-e-F_HackInit.ini","gef.sqf","JM3.sqf","pa.pbo","JM3.png","wookie.sqf","wookie_wuat\start.sqf","lystoarma3\start.sqf","help.sqf","hack.sqf","cheat.sqf","JxMxE.sqf","JME.sqf","wookiev5.sqf","menu.sqf"];			
_DetectedVariables = ["G-e-F_HackInit","G-e-F_HackInit.ini","Life41337","Team GEF","Team G-E-F","G-E-F","gef","personalarsenal","spawn","PA_arsenal","pa","ESP","Wookie","Extasy","GOD","GodMode","JxMxE_Exec","Lystic","Hack","Script","Wookie_Exec","Bypass"];
_DetectedMenus = [3030];
/* End Configuration */
...
_exists = loadFile "scripts\AdminMenu.sqf";
if(_exists != "") then {

...
if (isnil "IL_Variables") then
{
	...
	// Supported vehicles
	IL_Supported_Vehicles_OFFROAD = ["C_Offroad_01_F", "B_G_Offroad_01_F", "B_mas_mar_Offroad_01_F", "B_G_Offroad_01_repair_F"];
	...
	IL_Supported_OFFROAD = ["C_Offroad_01_F", "B_G_Offroad_01_F", "B_G_Offroad_01_armed_F", "JTF2_Offroad_armed_01", "B_G_Offroad_01_repair_F", "B_mas_mar_Offroad_01_F", "B_mas_mar_Offroad_01_armed_F"];

...
{
_whistle = _unit addAction ["Loiserl komm!", _dogWhistle, [_unit, _dogGrowl,_playSound,_dogReturnIdle,_dogVehicle]];
...
{
_follow = _unit addAction ["<t color = '#ffff00'>Beifuß</t>", _dogFollow, [_unit,_playSound]];
_find = _unit addAction ["<t color = '#ffff00'>Sitz!</t>", _dogSeek, [_unit,_playSound]];
_rest = _unit addAction ["<t color = '#ff0000'>Ab ins Körbchen!</t>", _dogHide, [_unit,_playSound]];
_heel = _unit addAction ["<t color = '#ffff00'>Heilen!</t>", _dogHeel, [_unit,_playSound]];
_unit setvariable ["step","wait"];
...
{
_stop = _unit addAction ["<t color = '#ff0000'>Bleib!</t>", _dogStop, [_unit,_playSound]];
_unit setvariable ["step","wait"];
